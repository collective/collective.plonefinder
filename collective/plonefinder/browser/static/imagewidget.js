...
var author$project$ImageWidget$WidgetId = elm$core$Basics$identity;
...
var author$project$ImageWidget$OpenFinder = {$: 2};
var author$project$ImageWidget$alwaysPreventDefault = function (msg) {
...
var author$project$ImageWidget$onClickPreventDefault = function (msg) {
	return A2(
		elm$html$Html$Events$preventDefaultOn,
		'click',
		A2(
			elm$json$Json$Decode$map,
			author$project$ImageWidget$alwaysPreventDefault,
...
var author$project$ImageWidget$browse_button = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				author$project$ImageWidget$onClickPreventDefault(author$project$ImageWidget$OpenFinder)
			]),
		_List_fromArray(
			[
				elm$html$Html$text('Browse server')
			]));
};
...
var author$project$ImageWidget$remove_button = function (model) {
	return author$project$ImageWidget$hasImage(model) ? A2(
		...
		_List_fromArray(
			[
				author$project$ImageWidget$onClickPreventDefault(author$project$ImageWidget$RemoveImage)
			]),
		_List_fromArray(
			[
...
var author$project$ImageWidget$buttons = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var author$project$ImageWidget$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				author$project$ImageWidget$field(model),
				author$project$ImageWidget$buttons(model),
				author$project$ImageWidget$image(model)
			]));
};
